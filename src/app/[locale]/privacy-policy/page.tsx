...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Directive 8020 Wiki',
    description: 'Directive 8020 Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Directive 8020 Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Directive 8020 Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Supermassive Games, Bandai Namco Entertainment, The Dark Pictures Anthology, Steam, Sony, Microsoft,
              or any official Directive 8020 publisher or platform holder. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@directive8020.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@directive8020.wiki</a>
            </p>
            <p>
