...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Directive 8020 Wiki",
    description: "Read the Terms of Service for Directive 8020 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Directive 8020 Wiki",
      description: "Terms and conditions for using Directive 8020 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Directive 8020 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Directive 8020 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Directive 8020 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Directive 8020 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the cinematic sci-fi survival horror game "Directive 8020". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Release date, platform, edition, and preorder information</li>
              <li>Official trailer coverage and video summaries</li>
              <li>Story, character, Cassiopeia, and Tau Ceti f reference material</li>
              <li>Choice, Turning Points, co-op, and survival horror guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Directive 8020 Wiki is NOT affiliated with, endorsed by, or associated with
              Supermassive Games, Bandai Namco Entertainment, The Dark Pictures Anthology, Steam, Sony, Microsoft,
              or any official Directive 8020 publisher or platform holder. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Directive 8020 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Supermassive Games, Bandai Namco Entertainment, The Dark Pictures Anthology,
              and their respective owners. We use such
            ...
            <ul>
              ...
              <li><strong>Availability:</strong> Release timing, preorder details, platform support, and game updates may change without notice. We are not responsible for store availability or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              ...
              you and Directive 8020 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@directive8020.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@directive8020.wiki</a>
            </p>
            <p>
