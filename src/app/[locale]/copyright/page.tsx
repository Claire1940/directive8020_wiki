...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Directive 8020 Wiki',
    description: 'Copyright and intellectual property information for Directive 8020 Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Directive 8020 Wiki',
      description: 'Copyright and intellectual property information for Directive 8020 Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Directive 8020 Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Directive 8020 Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Directive 8020 Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Supermassive Games</strong> - Developer of Directive 8020</li>
              <li><strong>Bandai Namco Entertainment</strong> - Publisher and official website operator</li>
              <li><strong>The Dark Pictures Anthology</strong> - Series branding and official channels</li>
              <li><strong>Steam, PlayStation, and Xbox</strong> - Platform and store brands owned by their respective companies</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>Directive 8020</strong> - Trademark or branding of its respective rights holders</li>
              <li><strong>The Dark Pictures Anthology</strong> - Trademark or branding of its respective rights holders</li>
              ...
              <li><strong>Xbox</strong> - Trademark of Microsoft</li>
              <li><strong>Directive 8020 Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Directive 8020 Wiki.
            </p>
            ...
            <p>
              ...
              Directive 8020 Wiki<br />
              Email: <a href="mailto:dmca@directive8020.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@directive8020.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Directive 8020 Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Directive 8020 Wiki (directive8020.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@directive8020.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@directive8020.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@directive8020.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@directive8020.wiki</a>
            </p>
            <p>
